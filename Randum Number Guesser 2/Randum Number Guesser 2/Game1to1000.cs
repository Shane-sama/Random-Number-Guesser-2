...
public class Game1to1000
{
        ...
        while (Guess != Result)
        {
            try
            {
                ...
                else if (Guess == Result)
                {
                    if (Result == 727)
                    {
                        string Osu727 = "727. 727!!! WHEN YOU SEE IT!!! WHEN YOU FUCKING SEE IT!!! 7272!!!";
                        foreach (char c in Osu727)
                        {
                            Console.Write(c);
                            Thread.Sleep(80);
                        }
            ...
            catch
            {
                ...
                string[] NoU =
                {
                    "Stop it kid, only numbers from 1 to 1000!",
                    "Already told you, only numbers from 1 to 1000!",
                    "You didn't understand me? Only numbers from 1 to 1000!",
                    "Listen kid, you dont have to go too crazy with this, just use numbers from 1 to 1000!",
    ...
    public static int One2Thousand()
    {
        int rndNumber = new Random().Next(1, 1000);
        return rndNumber;
    }
}